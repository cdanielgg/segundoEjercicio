...
public class DiaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mPosition) {
            case 0:
                textViewFragmento.setText("ALBUNES");
                break;
            case 1:
                textViewFragmento.setText("GENEROS");
                break;
            case 2:
                textViewFragmento.setText("Miercoles");
                break;
            case 3:
                textViewFragmento.setText("ARTISTAS");
                break;
            case 4:
                textViewFragmento.setText("PISTAS");
                break;
