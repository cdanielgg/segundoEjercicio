...
public class SeccionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//MUESTRA EL ICONO PARA RETROCEDER A LA ACTIVIDAD PADRE
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == INSERTAR) {
            Toast.makeText(getApplicationContext(), "Acabas de pulsar INSERTAR",Toast.LENGTH_SHORT).show();
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            MenuItem menuItem = menu.add(Menu.NONE,INSERTAR, Menu.NONE, "Insertar");
